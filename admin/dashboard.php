...
$reservasPendentes = $reserva->getReservasPendentes();
...
$reservasPendentesCount = count($reservasPendentes);
?>
    ...
    <main class="container">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body text-center">
                        <h3 class="text-warning"><?php echo $reservasPendentesCount; ?></h3>
                        <p>Pendentes</p>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <h3>⏳ Reservas Pendentes (<?php echo $reservasPendentesCount; ?>)</h3>
            </div>
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php foreach ($reservasPendentes as $reserva_item): ?>
                                    <tr>
                                        <td>
